  ...
  public class ImageBoxEx : ImageBox
  {
    ...
    private void ProcessSelectionMove(Point cursorPosition)
    {
        if (this.IsMoving)
        {
            ...
            //WSApp.Instance().m_Config.ds_DATA_0.Tables[3 + WSApp.Instance().m_mainform.ctr_ROI1.Selected_num].Rows[0][1] = SelectionRegion.X;
            //WSApp.Instance().m_Config.ds_DATA_0.Tables[3 + WSApp.Instance().m_mainform.ctr_ROI1.Selected_num].Rows[0][2] = SelectionRegion.Y;
            //WSApp.Instance().m_Config.ds_DATA_0.Tables[3 + WSApp.Instance().m_mainform.ctr_ROI1.Selected_num].Rows[1][1] = SelectionRegion.Width;
            //WSApp.Instance().m_Config.ds_DATA_0.Tables[3 + WSApp.Instance().m_mainform.ctr_ROI1.Selected_num].Rows[1][2] = SelectionRegion.Height;
        }
    }

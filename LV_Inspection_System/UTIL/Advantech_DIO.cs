    ...
    public class Advantech_DIO
    {
        ...
        public void Initialize()
        {
            ...
            try
            {
                ...
                //inst_Do.SelectedDevice = new DeviceInformation(0);
                inst_Do.SelectedDevice = new DeviceInformation(Do_devicce_list[0].Description);
                ...
                //inst_Di.SelectedDevice = new DeviceInformation(0);
                inst_Di.SelectedDevice = new DeviceInformation(Di_devicce_list[0].Description);
            ...
            try
            {
                while (Di_thread_flag)
                {
                    ...
                    for (int port = 0; port < 2; port++)
                    {
                        ...
                        //if (portData == 0x01)
                        //{
                        //    LVApp.Instance().m_mainform.add_Log("OLD_" + t_Byte.ToString()  + "  "+ "Now_" + portData.ToString());
                        //}
                        ...
                        if (portData != 0x00)
                        {
                            if (CAM_Di_Port[0] == port)
                            {
                                ...
                                {
                                    if (!LVApp.Instance().m_MIL.CAM0_Grabbing)
                                    {
                            ...
                            if (CAM_Di_Port[1] == port)
                            {
                                ...
                                {
                                    if (!LVApp.Instance().m_MIL.CAM1_Grabbing)
                                    {
                            ...
                            if (CAM_Di_Port[2] == port)
                            {
                                ...
                                {
                                    if (!LVApp.Instance().m_MIL.CAM2_Grabbing)
                                    {
                            ...
                            if (CAM_Di_Port[3] == port)
                            {
                                ...
                                {
                                    if (!LVApp.Instance().m_MIL.CAM3_Grabbing)
                                    {

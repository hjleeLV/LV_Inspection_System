...
Friend Class DrawingBoard
    ...
    'Member Variables
    Private m_MouseButtons As System.Windows.Forms.MouseButtons = Windows.Forms.MouseButtons.Right
    ...
    Public m_DrawRectMode As Boolean = False
...
#Region "Public Properties"
    ...
    Public Property ZoomFactor() As Double
        ...
        Set(ByVal value As Double)
            m_ZoomFactor = value
            If m_ZoomFactor > 100 Then m_ZoomFactor = 100
            If m_ZoomFactor < 0.01 Then m_ZoomFactor = 0.01
            If Not m_OriginalImage Is Nothing Then
...
#End Region
    ...
    Private Sub DrawingBoard_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load

    End Sub

    Private Sub DrawingBoard_Paint(sender As System.Object, e As System.Windows.Forms.PaintEventArgs) Handles MyBase.Paint
